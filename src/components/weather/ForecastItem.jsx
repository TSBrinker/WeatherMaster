...
// Create a memoized version of ForecastItem to prevent unnecessary re-renders
const ForecastItem = React.memo(({ hourData, isNow }) => {
  ...
  return (
    ...
    >
      ...
      {/* Temperature */}
      <div className="temperature font-bold mb-1">{hourData.temperature}°F</div>
