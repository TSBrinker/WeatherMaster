...
export const weatherEffects = {
    ...
    "High Winds": "Turbulent gusts sweep across the land. Flying creatures gain +10 movement speed when moving with the wind, and –10 movement speed when moving against it. All ranged weapon attacks have a –2 to attack rolls, and their range is reduced by half when shooting into the wind.",
  ...
  // Additional effect for Shooting Star (displayed alongside other conditions)
  export const shootingStarEffect = "Shooting stars streak across the night sky. All creatures gain 1 luck point as per the Lucky feat, which lasts until used or the weather changes. If you travel 4 or more hours outdoors through this weather, roll a d100. On a 1, a meteor strikes nearby, leaving devastation in its wake, but perhaps you'll find something valuable.";